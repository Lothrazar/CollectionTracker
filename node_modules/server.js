...
//request.method is GET,POST,etc.. if we need it
  ...
  { 
      ...
      var json_result = rest.call(tokens,request.method, function(err, rows, fields) 
      {
          if (err)  console.log(err);
    
          var json_result = rows; 
  
          if(typeof json_result != 'string') json_result = JSON.stringify(json_result);
